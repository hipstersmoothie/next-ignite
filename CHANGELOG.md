...
- add "none" layout ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- target modern JS ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- only render domain if url is configured ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
# v0.10.2 (Sun Feb 14 2021)

#### ⚠️ Pushed to `master`

- further fix graph url problem ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- include types in npm package ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
# v0.9.18 (Thu Feb 11 2021)

#### ⚠️ Pushed to `master`

- actually use plugins ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- use manifest description instead ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- fix logo link href ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- debounce + optimize search input ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- make configuration configurable ([@hipstersmoothie](https://github.com/hipstersmoothie))
